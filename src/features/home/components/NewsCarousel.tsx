      ...
      <div className="max-w-[1440px] w-full mx-auto relative px-4 lg:px-0">
        ...
        <div className="absolute lg:left-[944px] lg:top-[410px] lg:min-w-[385px] w-full z-20 flex items-end justify-between gap-6 lg:w-auto static lg:absolute mb-8 lg:mb-0">
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              >
                <path
                  d="M11.293 4.29289C11.6835 3.90237 12.3165 3.90237 12.707 4.29289L19.707 11.2929C20.0976 11.6834 20.0976 12.3164 19.707 12.707L12.707 19.707C12.3165 20.0975 11.6835 20.0975 11.293 19.707C10.9024 19.3164 10.9024 18.6834 11.293 18.2929L16.5859 12.9999H5C4.44772 12.9999 4 12.5522 4 11.9999C4 11.4476 4.44772 10.9999 5 10.9999H16.5859L11.293 5.70696C10.9024 5.31643 10.9024 4.68342 11.293 4.29289Z"
                  fill="#A4B1C7"
                ></path>
              </svg>
            </button>
            ...
            >
              ...
              >
                <path
                  d="M11.2929 4.29289C11.6834 3.90237 12.3164 3.90237 12.707 4.29289C13.0975 4.68342 13.0975 5.31643 12.707 5.70696L7.41399 10.9999H18.9999C19.5522 10.9999 19.9999 11.4476 19.9999 11.9999C19.9999 12.5522 19.5522 12.9999 18.9999 12.9999H7.41399L12.707 18.2929C13.0975 18.6834 13.0975 19.3164 12.707 19.707C12.3164 20.0975 11.6834 20.0975 11.2929 19.707L4.29289 12.707C3.90237 12.3164 3.90237 11.6834 4.29289 11.2929L11.2929 4.29289Z"
                  fill="#646C79"
                ></path>
              </svg>
            </button>
        ...
        <div className="relative w-full h-[600px] lg:h-[832px] mt-12 lg:mt-0">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="absolute lg:left-[736px] lg:top-[502px] left-4 bottom-[-100px] lg:bottom-auto w-[calc(100%-32px)] lg:w-[592px] min-h-[356px] bg-[#012D74] p-7 lg:p-10 flex flex-col justify-center items-start z-10"
          >
            {/* Date */}
            <div className="flex items-center gap-3 mb-6">
              <span className="text-white text-lg lg:text-xl font-normal opacity-90">
                {t(currentItem.dateKey)}
              </span>
              <svg
                width="24"
                height="24"
            ...
            <div className="mt-auto group cursor-pointer relative inline-flex items-center gap-8 self-start px-6 py-4">
              <span className="text-white text-lg font-medium relative z-10">
                {t("news.moreButton", "المزيد")}
              </span>
              <svg
                width="24"
                height="24"
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="relative z-10 group-hover:-translate-y-1 group-hover:translate-x-[-2px] transition-transform"
              >
                <path
