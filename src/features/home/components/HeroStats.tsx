...
const HeroStats = forwardRef<HTMLDivElement, HeroStatsProps>(
  ({ descTextRef, descLogosRef, loadingBarRef }, ref) => {
            ...
            <div className="flex-1 p-8 lg:p-12">
              ...
              <div ref={descLogosRef} className="absolute space-y-6 z-20">
                <CertificationLogo
                  ...
                  title={t(
                    "hero.certifications.tadawul.title",
                    "تداول – السوق المالية السعودية",
                  )}
                  subtitle={t(
                    "hero.certifications.tadawul.subtitle",
                    "شركة مدرجة",
                  )}
                />
                <CertificationLogo
                  ...
                  subtitle={t(
                    "hero.certifications.gptw.subtitle",
                    "شهادة أفضل بيئة عمل",
                  )}
                />
                <CertificationLogo
                  ...
                  subtitle={t(
                    "hero.certifications.platinum.subtitle",
                    "مزود خدمة معتمد من هيئة الحكومة الرقمية",
                  )}
                />
              </div>
            </div>
            ...
            <div className="w-full lg:w-[600px] grid grid-cols-1">
              <StatItem
                ...
                label={t(
                  ...
                  "إجمالي قيمة المشاريع خلال الأربع سنوات الأخيرة",
                )}
                decimals={true}
              />
              <StatItem
