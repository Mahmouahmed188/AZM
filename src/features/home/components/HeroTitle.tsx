...
const HeroTitle = forwardRef<HTMLDivElement, HeroTitleProps>(
  ({ swirlRef }, ref) => {
    ...
    return (
      <div ref={ref} className="max-w-[1200px] w-full" dir={dir}>
        <div className="title-line flex items-center justify-start gap-4 mb-4">
          <span className="text-[40px] md:text-7xl lg:text-8xl font-bold text-white leading-none">
        ...
        <div className="title-line flex items-center justify-start gap-4">
          ...
          <span className="text-[40px] md:text-7xl lg:text-8xl font-bold text-white leading-none tracking-tight">
            {t("hero.subtitle", "لجودة حياة")}
          </span>
          <div className="relative inline-block">
            <span className="relative text-[40px] md:text-7xl lg:text-8xl font-bold text-white leading-none tracking-tight z-10">
